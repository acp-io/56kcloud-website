...
export default function CertificationsBadgesWithTitle(
	props: CertificationsBadgesWithTitleProps,
) {
	const title = replaceBrTagWithNewline(props.title);
	const subtitle = props.subtitle
		? replaceBrTagWithNewline(props.subtitle)
		: undefined;
			...
			<div className="py-20 lg:pb-[104px] lg:pt-[120px]">
             ...
             bg-clip-text text-secondary-500 lg:leading-[58px]"
					...
					<Image
						...
						alt={
							props.horizontalBadgesImage.alternateText ||
							props.horizontalBadgesImage.name
						}
					/>
					<Image
						...
						alt={
							props.verticalBadgesImage.alternateText ||
							props.verticalBadgesImage.name
						}
					/>
				</div>
			</div>
