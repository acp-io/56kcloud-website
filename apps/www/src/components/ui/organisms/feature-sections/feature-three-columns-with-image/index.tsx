...
export default function FeatureThreeColumnsWithImage(
	props: FeatureThreeColumnsWithImageProps,
) {
	return (
								...
								<Link key={index} href={feature.link}>
									<div className="relative border border-slate-800 rounded-3xl w-full h-[528px] overflow-hidden">
										<div className="relative w-full h-full overflow-hidden">
											...
											/>
											<div className="w-full h-full absolute left-0 bottom-0 bg-slate-900" />
										</div>
										<div className="absolute left-0 bottom-0 flex flex-col p-6 pt-0 sm:p-8">
											<div className="space-y-4">
												<h3 className="text-2xl leading-7 font-semibold w-fit text-primary-500">
													{feature.title}
												</h3>
